namespace IronFoundry.Vcap
{
    ...
    internal class InfoHelper : BaseVmcHelper
    {
        ...
        {
            var r = base.BuildVcapRequest(Constants.AppsPath, argApp.Name, argInstance, "files/logs/stderr.log");
            return r.Execute().Content;
        }

        public string GetStdOutLog(Application argApp, ushort argInstance)
        {
            var r = base.BuildVcapRequest(Constants.AppsPath, argApp.Name, argInstance, "files/logs/stdout.log");
            return r.Execute().Content;
        }

        public string GetStartupLog(Application argApp, ushort argInstance)
        {
            var r = base.BuildVcapRequest(Constants.AppsPath, argApp.Name, argInstance, "files/logs/startup.log");
            return r.Execute().Content;
        }
        ...
        {
            VcapRequest r = base.BuildVcapRequest(Constants.AppsPath, app.Name, "stats");
        ...
        {
            var r = base.BuildVcapRequest(Constants.AppsPath, argApp.Name, "instances");
